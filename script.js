let palavras = ["Brasil", "China", "Alemanha", "Portugal", "Argentina", "Canada", "Russia", "Mexico", "Finlandia", "Peru", "Australia"];
...
for (posicao = 0; posicao < letras.length; posicao++) {
    ...
    botao.setAttribute("onclik", "escolheLetra(\" "+letras[posicao]+"\")");
